...
<div class="wrap">
	<div class="payment">
    	<ul>
        	<li onclick="pay(1000)">
                <div class="num01">1<font>～</font>100</div>
                <div class="num02">元</div>
                <div class="num03">仅需要支付<font>10</font>元</div>
            </li>
            <li onclick="pay(2000)">
           		<div class="num01">5<font>～</font>200</div>
                <div class="num02">元</div>
                <div class="num03" >仅需要支付<font>20</font>元</div>
            </li>
            <li onclick="pay(5000)">
           		<div class="num01">30<font>～</font>600</div>
                <div class="num02">元</div>
                <div class="num03">仅需要支付<font>50</font>元</div>
            </li>
            <li onclick="pay(10000)">
           		<div class="num01">50<font>～</font>1200</div>
                <div class="num02">元</div>
